...
export type RoadmapPreviewStep = {
  id: string;
  label: "Start" | "Skills" | "Project" | "Portfolio" | "Opportunity";
  description: string;
...
const defaultPathOrder: RoadmapPreviewStep["label"][] = [
  "Start",
  "Skills",
  "Project",
  "Portfolio",
...
function getOrderedSteps(steps: RoadmapPreviewStep[]) {
  return [...steps].sort(
    (a, b) => defaultPathOrder.indexOf(a.label) - defaultPathOrder.indexOf(b.label),
  );
}
